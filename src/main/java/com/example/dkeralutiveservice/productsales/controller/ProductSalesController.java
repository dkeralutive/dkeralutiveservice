package com.example.dkeralutiveservice.productsales.controller;
...
import com.example.dkeralutiveservice.productsales.service.Productsalesservice;
...
@RestController
@RequestMapping(value = "/api/v1/productsales", produces = {MediaType.APPLICATION_JSON_VALUE})
